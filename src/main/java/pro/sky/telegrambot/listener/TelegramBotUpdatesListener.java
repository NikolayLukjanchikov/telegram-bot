...
public class TelegramBotUpdatesListener implements UpdatesListener {
    ...
    @Override
    public int process(List<Update> updates) { // обработка запросов бота ([0-9\.\:\s]{16})(\s)([\W+]+)
        ...
        updates.forEach(update -> {
            ...
            if (matcher.matches()) {
                ...
                SendResponse dateMessage = telegramBot.execute(new SendMessage(update.message().chat().id(), reminderReturnMessage));
